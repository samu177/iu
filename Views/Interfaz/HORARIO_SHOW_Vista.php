  ...
  <div class="col-md-2 ">
        ...
        <div class="panel panel-default"><!-- Gestion de fisioterapeuta -->
          ...
          <div id="gestFisio" class="panel-collapse collapse">
            <ul class="list-group">
              <li class="list-group-item"><?=GEST_FISIOHADD?></li>
              <li class="list-group-item"><?=GEST_FISIOHSELECT?></li>
              <li class="list-group-item"><?=GEST_FISIORADD?></li>
              <li class="list-group-item"><?=GEST_FISIORSELECT?></li>
            </ul>
          </div>
